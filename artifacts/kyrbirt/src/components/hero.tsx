...
export function Hero() {
  ...
  return (
    <section
      ...
      style={{ background: "radial-gradient(ellipse at 60% 30%, #1e1e1e 0%, #0c0c0c 60%, #050505 100%)" }}
    >
      {/* CSS background image (loaded from admin settings) — shows only when URL is set and loads */}
      {bgImage && (
        <div
          className="absolute inset-[24px] z-0"
          style={{
